...
class XLSXWriter {
    ...
    protected function initializeSheet($sheet_name, $col_widths = array(), $auto_filter = false, $freeze_rows = false, $freeze_columns = false, $data_start_index = 0) {
    ...
    public function writeSheetHeader($sheet_name, array $header_types, $col_options = null) {
        ...
        $data_start_index = isset($col_options['data_start_index']) ? intval($col_options['data_start_index']) : 0;
        self::initializeSheet($sheet_name, $col_widths, $auto_filter, $freeze_rows, $freeze_columns, $data_start_index);
        $sheet = &$this->sheets[$sheet_name];
    ...
    public function writeSheetRow($sheet_name, array $row, $row_options = null) {
        ...
        $c = 0;
        foreach ($row as $v) {
            if ($sheet->row_count >= $sheet->data_start_index) {
